          ...
          <div className="row">
            ...
            <div className="col-6 my-3">
              <div className="d-flex align-items-center">
                ...
                <h4 className="ms-4 mb-0 fw-bold">Laundry Kiloan</h4>
              </div>
            ...
            <div className="col-6 my-3">
              <div className="d-flex align-items-center">
                ...
                <h4 className="ms-4 mb-0 fw-bold">Laundry Satuan</h4>
              </div>
              <div className="table-con mt-4">
                <table className="table table-bordered">
                  <thead>
            ...
            <div className="col-6 my-3">
              <div className="d-flex align-items-center">
                ...
                <h4 className="ms-4 mb-0 fw-bold">Cuci Karpet</h4>
              </div>
              <div className="table-con mt-4">
                <table className="table table-bordered">
                  <thead>
            ...
            <div className="col-6 my-3">
              <div className="d-flex align-items-center">
                ...
                <h4 className="ms-4 mb-0 fw-bold">Laundry Sepatu</h4>
              </div>
              <div className="table-con mt-4">
                <table className="table table-bordered">
                  <thead>
            ...
            <div className="col-6 my-3">
              <div className="d-flex align-items-center">
                ...
                <h4 className="ms-4 mb-0 fw-bold">Laundry Perlengkapan Bayi</h4>
              </div>
              <div className="table-con mt-4">
                <table className="table table-bordered">
                  <thead>
